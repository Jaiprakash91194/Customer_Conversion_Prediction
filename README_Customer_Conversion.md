...
# GUVI Customer Conversion Prediction:

An Application to predict whether a customer will opt for an insurance policy.
![Random GIF](https://c.tenor.com/b5J9lCPQlAEAAAAi/democracyrising-our-time-now-for-our-health.gif)
## Description:

The application can predict whether the customer will opt for insurance plan based on various features taken into consideration.
...
This is a real world Datascience problem, given in DATATHAON1.0, which is conducted by GUVI.
